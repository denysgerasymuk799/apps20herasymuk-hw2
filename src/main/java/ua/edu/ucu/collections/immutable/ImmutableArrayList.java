...
public class ImmutableArrayList implements ImmutableList{
    ...
    private ImmutableArrayList getModifiedCopy(int buffer) {
        ImmutableArrayList copyArrayList = new ImmutableArrayList(arraySize + buffer);

        System.arraycopy(immutableArray, 0, copyArrayList.toArray(), 0, arraySize);
    ...
    private ImmutableArrayList addGeneral(int index, Object e){
        ...
        ImmutableArrayList newImmutableArray = new ImmutableArrayList(size() + 1);
    ...
    private ImmutableArrayList addAllGeneral(int index, Object[] c){
        ...
        ImmutableArrayList newImmutableArray = new ImmutableArrayList(size() + c.length);
    ...
    public ImmutableList remove(int index) {
        ...
        System.arraycopy(immutableArray, 0, newImmutableArray.toArray(), 0, index);
        System.arraycopy(immutableArray, index + 1, newImmutableArray.toArray(), index,
                size() - (index + 1));
        return newImmutableArray;
    }
